...
public:
	...
	/// <summary>
	/// Adds a lua handler to outgoing packets
	/// </summary>
...
protected:
	...
	std::vector<sol::function> SendHandlers;
	std::vector<sol::function> RPCHandlers;
	std::vector<sol::function> ReceiveRPCHandlers;
